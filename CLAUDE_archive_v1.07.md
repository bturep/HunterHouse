# CLAUDE_archive_v1.07.md — FROZEN
# Verbatim snapshot of CLAUDE.md at the end of 2026-05-21.
# Covers browse.html v1.06.00 (live promotion) through v1.06.18, and
# next.html v1.07-test.01 through v1.07-test.22 (admin editing surface
# fully built out + CAA renumber + cleanup pass). Read-only — never
# edited after freeze; subsequent sessions write to CLAUDE.md.
