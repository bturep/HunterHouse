...
> This is a verbatim freeze of `CLAUDE.md` at **v1.05.02 / next.html v1.06-test.03** (2026-05-19).
> It covers the project history **v1.03.00 → v1.05.02** (the era after `CLAUDE_archive_v1.02.md`).
...
# (FROZEN snapshot — see banner above. Earlier still: CLAUDE_archive_v1.02.md)
