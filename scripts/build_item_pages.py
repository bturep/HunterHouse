...
DEFAULT_QUERY_SOURCE = os.path.join(REPO, "browse.html")   # flipped back at the v1.09.00 promotion (2026-07-16): browse.html now carries ?rightsUri (P146). next.html remains a valid override via --query-from.
