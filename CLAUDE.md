...
- **Housekeeping:** add `scripts/__pycache__/` to `.gitignore`.
...
- **P100 reassignment.** No longer rendered in the record pane (curator notes migrated to researcher notes). Decide what P100 should become before next cataloguing session.
